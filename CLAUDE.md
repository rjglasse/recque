...
**YOU ARE IN: `recque/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/recque/` (rig root) or other directories
...
**Your mail address:** `recque/polecats/rust`
**Your rig:** recque
**Your Witness:** `recque/witness`
...
| Ask Witness for help | `gt mail send recque/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`recque/witness`) when:
...
```bash
gt mail send recque/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
